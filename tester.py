from flask import redirect_url, render_template, flash
import FlaskMail
app = Flask(__name__)
...
django.auth.generic.views import LoginView


   send_mass_mail((msg1, msg), sendto, recemail,)
# class Custom
# er(db.model):
#     "__tablename__" = "customer"
#     first_name = db.Column(db.Char)
#     last_name = db.Column(db.char)
